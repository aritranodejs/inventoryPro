...
const SupplierForm: React.FC<SupplierFormProps> = ({ supplier, onClose }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-fade-in">
            <div className="bg-gray-900 rounded-3xl shadow-2xl shadow-blue-900/20 w-full max-w-lg overflow-hidden flex flex-col border border-gray-800 animate-in zoom-in-95 duration-150">
